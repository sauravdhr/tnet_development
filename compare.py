...
def compare_tnet_best_tree():
	...
	F1_file = open('results/single_tree_tnet/best_tree.f1.tnet.new.with.min.bug.fixed.csv', 'w+')
	...
	for folder in folders:
		...
		for th in thresholds:
			tnet = set(ge.get_mul_tnet_edges(data_dir + folder + '/tnet_best_tree/bestTree.100.tnet_new_with_min_bug_fixed', th))
